  ...
  render() {
    ...
    return (
      <StyledTodoListControls>
        ...
        />
        { !!selectedItens.length && <Options data-testid="todo-list-controls">
          <TrashButton data-testid="remove-todo" onClick={ () => remove() } />
          <InProgressButton data-testid="in-progress-button" onClick={ () => inProgress() } />
          <DoneButton data-testid="done-button" onClick={ () => done() } />
        </Options> }
